    ...
    return {
        ...
        link: function($scope, element, attrs, controller){
            ...
            $scope.addJob = function(jobNumber, id, type, versionNumber){
                angular.element(document.getElementById(id)).append($compile("<report-after-effects-job remove-job='removeJob(jobNumber, id)' job-number=" + jobNumber + " job='newReport.tempafter_effects.jobs["+jobNumber+"].v001' ></report-after-effects-job>")($scope));
